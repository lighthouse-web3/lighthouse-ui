    ...
    <div className={Style.BlogView}>
      <div className={Style.BlogView__BannerImage}>
        <div
          ...
          style={{
            background:
              'url("https://images.unsplash.com/photo-1666808982292-501b1e002171?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80")',
