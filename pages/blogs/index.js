        ...
        <main className="pt-32 pb-20 px-6 w-full max-w-screen-2xl mx-auto flex-1">
          ...
          <header className="mb-16">
            ...
            <p className="max-w-xl text-lg text-[#cec2d7] leading-relaxed">
              Insights into decentralized storage, engineering breakthroughs,
              and the future of the Lighthouse ecosystem.
            </p>
          </header>
          ...
          {/* <div className="flex flex-wrap gap-4 mb-12">
            <button className="px-6 py-2 rounded-full bg-[#dab9ff] text-[#470084] font-bold text-sm tracking-tight transition-all cursor-pointer">
              All Posts
            </button>
            <button className="px-6 py-2 rounded-full bg-[#2a2a2a] text-[#cec2d7] hover:text-[#dab9ff] font-medium text-sm tracking-tight transition-all cursor-pointer">
              Engineering
            </button>
            <button className="px-6 py-2 rounded-full bg-[#2a2a2a] text-[#cec2d7] hover:text-[#dab9ff] font-medium text-sm tracking-tight transition-all cursor-pointer">
              AI
          ...
          <section className="mt-32 p-12 rounded-2xl bg-[#1b1c1c] border border-[#4c4354]/10 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center md:text-left">
                <h2 className="text-4xl font-headline font-bold text-[#e4e2e2] mb-4">
                  Stay at the Horizon.
                </h2>
                <p className="text-[#cec2d7]">
                  Get the latest technical deep dives and ecosystem updates
              ...
              <div className="w-full max-w-md">
                <div className="flex gap-2">
                  <input
                    className="flex-grow bg-[#343535] border-none rounded-lg outline-none focus:ring-2 focus:ring-[#dab9ff] text-[#e4e2e2] placeholder:text-[#cec2d7]/50 px-4"
                    placeholder="Enter your email"
                    type="email"
                  />
                  <button className="bg-[#dab9ff] text-[#470084] font-bold px-8 py-3 rounded-lg hover:brightness-110 transition-all cursor-pointer">
                    Subscribe
                  </button>
                </div>
                <p className="mt-3 text-[10px] text-[#cec2d7]/60 text-center md:text-left">
